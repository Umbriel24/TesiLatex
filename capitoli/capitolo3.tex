...
che garantisce il determinismo\footnote{"L'esperimento si può riprodurre molteplici volte, con risultato analogo grazie al determinismo di un seed inserito come parametro} dell'intera pipeline.
...
Ad esempio, con \texttt{micro\_drop} al 20\% su Oxford-IIIT Pet, applicato con seed \texttt{777}, sono state selezionate le razze \emph{Yorkshire Terrier}, \emph{English Setter}, \emph{German Shorthaired Pointer} e \emph{Boxer}. 
Le prime tre classi sono eliminate per intero, la quarta solo parzialmente.
