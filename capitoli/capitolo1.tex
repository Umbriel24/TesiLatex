...
Tale criticità nella classificazione costituisce il punto di partenza per l’analisi sperimentale presentata. Per valutare la robustezza dei classificatori gerarchici, il presente studio introduce delle riduzioni controllate del dataset di addestramento, operando su due configurazioni distinte: drop a livello \textit{coarse} (riduzione quantitativa del dataset, senza intaccare totalmente alcuna classe) e drop a livello \textit{fine} (riduzione selettiva attraverso la rimozione completa di una o più classi).
...
Il Capitolo 2 descrive la pipeline adottata, i dataset utilizzati, le tipologie di reti adottate, le definizioni e implementazioni dei drop a livello coarse e fine. Si conclude con la configurazione degli esperimenti condotto

Il Capitolo 3 presenta i risultati relativi all’impatto dei drop coarse e fine sulla performance dei classificatori, analizzando (per ogni categoria e intensità di drop) l’effetto che questi provocano nelle diverse reti.

Il Capitolo 4 affronta il caso critico di classi totalmente escluse dal training set, illustrando l’approccio basato su reti prototipiche. In particolare, il capitolo mostra come un modello, pur non avendo mai osservato determinata classi in fase di training, sia comunque in grado di discriminare e di distinguerle da altre classi partendo da poche immagini di supporto

Il Capitolo 5 conclude la tesi riassumendo i risultati ottenuti, discutendo i limiti dello studio e possibili sviluppi futuri
