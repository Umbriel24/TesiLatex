...
Si consideri, a titolo esemplificativo, un dataset strutturato su due livelli generali: \textit{Piante} e \textit{Animali}, articolati a loro volta in \textit{Arboree} ed \textit{Erbacee} la prima, \textit{Mammiferi} e \textit{Pesci} la seconda.
...
Tale criticità nella classificazione costituisce il punto di partenza per l’analisi sperimentale presentata. 

Per valutare la robustezza dei classificatori gerarchici, il presente studio introduce delle riduzioni controllate del dataset di addestramento, 
operando su due configurazioni distinte: drop a livello \textit{coarse} e drop a livello \textit{fine}.
